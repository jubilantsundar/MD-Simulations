...
if [ $# -lt 7 ]; then
   ...
   echo "Usage: ./autoGromacsMD.sh apo/complex input.pdb ligand_gro_file ligand_itp_file simulation_length_in_ps prep/prod Protein/DNA/RNA"
   ...
   echo "  Example for complex system: ./autoGromacsMD.sh complex input.pdb lig.gro lig.itp 5000000 prod RNA_LIG"
   echo "  Example for apo system: ./autoGromacsMD.sh apo input.pdb . . 5000000 prod RNA"
